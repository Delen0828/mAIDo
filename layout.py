...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.textEdit.setGeometry(QtCore.QRect(50, 30, 201, 35))
        self.textEdit.setObjectName("textEdit")
        self.AddButton = QtWidgets.QPushButton(Form)
        self.AddButton.setGeometry(QtCore.QRect(300, 30, 100, 23))
        self.AddButton.setObjectName("AddButton")
        self.AddButton.clicked.connect(Form.add)
        self.DeleteButton = QtWidgets.QPushButton(Form)
        self.DeleteButton.setGeometry(QtCore.QRect(300, 60, 100, 23))
        self.DeleteButton.setObjectName("DeleteButton")
        self.DeleteButton.clicked.connect(Form.Delete)
        self.TaskDue = QtWidgets.QDateTimeEdit(Form)
        self.TaskDue.setGeometry(QtCore.QRect(50, 70, 194, 22))
        self.TaskDue.setObjectName("dateTimeEdit")
        self.comboBox = QtWidgets.QComboBox(Form)
        self.comboBox.setGeometry(QtCore.QRect(50, 100, 69, 22))
        self.comboBox.setObjectName("comboBox")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.tableWidget=QtWidgets.QTableWidget(Form)
        self.tableWidget.setGeometry(QtCore.QRect(50, 130, 500, 350))
